        ...
        for seed1 in seeds:
            ...
            for model2 in models:
                for revision2 in revisions:
                    for seed2 in seeds:
                        if model1 == model2 and revision1 == revision2 and revision1 == revisions[-1]:
...
df.to_csv(f'../working_dir/{sys.argv[1]}/output/seeds_token_divergence_dataframe.csv')
